...
local tweenTime, createTitle, getPlaneFromName, rgbColour = _G.tweenTime, _G.createTitle, _G.getPlaneFromName, _G.rgbColour
...
do
  ...
  local _base_0 = {
    initialize = function(self)
      ...
      local plane = getPlaneFromName(self.planeName)
      local sectionNames = (function()
        local _accum_0 = { }
        local _len_0 = 1
        local _list_1 = plane:GetChildren()
      ...
      for _index_0 = 1, #_list_1 do
        ...
        repeat
          ...
          local section = plane[sectionName]
          local colour = nil
