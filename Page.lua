...
do
  ...
  local _class_0 = setmetatable({
    __init = function(self, name, parentPage)
      ...
      do
        ...
        _with_0.Name = name
        if parentPage and parentPage.background then
          _with_0.Parent = parentPage.background
          _with_0.Position = UDim2.new(1, 0, 0, 0)
          _with_0.BackgroundTransparency = menuBackgroundFrame.BackgroundTransparency
        else
          _with_0.Parent = menuBackgroundFrame
