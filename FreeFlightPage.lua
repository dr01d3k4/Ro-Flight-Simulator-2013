...
local rgbColour, setCurrentMenuPage, createTitle, tweenTime, tweenExtra, createBackButton, getAllPlaneNames, camera, head = _G.rgbColour, _G.setCurrentMenuPage, _G.createTitle, _G.tweenTime, _G.tweenExtra, _G.createBackButton, _G.getAllPlaneNames, _G.camera, _G.head
do
  ...
  local _base_0 = {
    initialize = function(self)
      ...
      if self.planePreviewBase then
        self.planePreviewBase:Destroy()
      end
      do
        local _with_0 = Instance.new("Part", camera)
        _with_0.Anchored = true
        _with_0.BrickColor = BrickColor.new("Dark grey")
        _with_0.FormFactor = "Custom"
        _with_0.Size = self.baseSize
        _with_0.Name = "PlanePreviewBase"
        _with_0.CFrame = CFrame.new(0, 20, 0)
        _with_0.TopSurface = "Smooth"
        _with_0.BottomSurface = "Smooth"
        self.planePreviewBase = _with_0
      end
      Instance.new("CylinderMesh", self.planePreviewBase)
      head.CFrame = self.planePreviewBase.CFrame
      ...
      onClickFunction = function(index, item, button)
        ...
        return self:setChildPage(_G.LiverySelectPage, self, realName)
      end
  ...
  local _class_0 = setmetatable({
    __init = function(self, parent)
      ...
      self.planePreviewBase = nil
      self.baseSize = Vector3.new(3, 0.2, 3)
    end,
    __base = _base_0,
